...
class WhatsAppLocation implements WhatsApp
{
	use Strict;
	...
	/**
	 * @return array{sender: string, expiration: int<60, max>, location: array{latitude: float, longitude: float, name: string, address: string}}
	 */
