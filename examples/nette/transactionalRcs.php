...
use BulkGate\Sdk\{Configurator\RcsConfigurator, Message\Component\Rcs\Suggestion\ViewLocation, Message\Component\Rcs\Variant, Message\Rcs, Scheduler\Simple, Sender};
...
try
{
	...
	$sender->addSenderConfigurator(new RcsConfigurator(sender: 'BulkGate'));
