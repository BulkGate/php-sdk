...
use BulkGate\Sdk\{Message\Viber, Sender};
...
$viber = new Viber('420777777777', 'test message', /** @info YOU MUST HAVE REGISTERED VIBER SENDER ID -> Contact us -> support@bulkgate.com */ 'BulkGate');
